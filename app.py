...
Provide the explanation and steps in Ukranian Language. Mathematical formulas and expressions should be in English using LaTeX ($...$ or $$...$$).
...
Provide your feedback and explanations in Ukranian Language. Mathematical formulas and expressions should be in English using LaTeX ($...$ or $$...$$).
...
def build_pratice_prompt_parts(problem_text, no_questions):
    ...
    """
    # Combine all instructional text and user problem text into one string
    # Modified instructional_text to request Ukranian Language problems and English math
    instructional_text = f"""You are MathMind AI, an expert AI Math Tutor.
Your goal is to generate practice problems which are having same concept as in below given problem's solution.
Generate the problem text in Ukranian Language. Mathematical formulas and expressions within the problems should be in English using LaTeX ($...$ or $$...$$).
---
...
def build_clarification_prompt_parts(original_problem_text, original_file_uri, full_solution, step_number, user_question):
    ...
    # Modified prompt to request Ukranian Language clarification and English math
...
Provide the clarification and explanation in Ukranian Language. Mathematical formulas and expressions should be in English using LaTeX ($...$ or $$...$$).
...
def refresher():
    ...
    # Modified refresher_prompt to request Ukranian Language explanations and English math within JSON values
    ...
    Provide the description, example explanations, and solved question explanations/solutions in Ukranian Language. Mathematical formulas and expressions within these values should be in English using LaTeX ($...$ or $$...$$).
    ...
    "concept_description": "<Detailed description in Ukranian Language with English math>",
    "example": "<Example as plain string in Ukranian Language with English math>",
    "solved_questions": [
    {{"question": "<Problem 1 in Ukranian Language with English math>", "solution": "<Solution 1 as plain string in Ukranian Language with English math>"}},
    {{"question": "<Problem 2 in Ukranian Language with English math>", "solution": "<Solution 2 as plain string in Ukranian Language with English math>"}}
